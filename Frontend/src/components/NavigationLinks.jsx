...
const navLinks = [
  {
    to: "/htmlcssjs",
    text: "HTML, CSS, JS",
    icon: <div className="flex space-x-1"><BiTerminal className="text-white" /></div>,
  ...
  },
  {
    ...
    text: "Javascript",
    icon: <SiJavascript />,
    classes: "from-green-400 to-green-500",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/c",
    text: "C",
    icon: <FaC />,
    classes: "from-green-600 to-green-700",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/cpp",
    text: "C++",
    icon: <SiCplusplus />,
    classes: "from-green-700 to-green-800",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/java",
  ...
  },
  {
    ...
    text: "Go",
    icon: <SiGo />,
    classes: "from-green-500 to-teal-500",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/verilog",
    text: "Verilog",
    icon: <TbBinaryTree />,
    classes: "from-green-800 to-green-900",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/sql",
  ...
  },
  {
    ...
    text: "Typescript",
    icon: <SiTypescript />,
    classes: "from-green-600 to-green-500",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/dart",
    text: "Dart",
    icon: <SiDart />,
    classes: "from-green-400 to-blue-500",
    glowColor: "rgba(0, 255, 0, 0.5)",
  },
  {
    to: "/kotlin",
...
const NavigationLinks = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative flex flex-col items-center justify-center min-h-[40vh] px-4 pt-20 pb-12 hacker-particles hacker-bg-lines overflow-hidden">
        {/* Animated Background Grids */}
        <div className="absolute inset-0 hacker-grid-bg opacity-30"></div>
        ...
        <h1 className="text-5xl md:text-6xl lg:text-8xl font-black mb-6 text-center z-10">
          <span className="hacker-holographic hacker-title-glow tracking-tighter">
            CodeBuddi
          </span>
        </h1>
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 text-center max-w-2xl">
          ...
          <span className="text-green-500 font-medium">AI-Powered</span> Code Generation
        </p>
